...
def gameLoop():
    ...
    while not gameExit:
        ...
        #Render Logic
        screen.fill(white)
        message_to_screen("Player one",blue,-200,-250,"small")
        message_to_screen(str(score1),blue,-200,-150,"small")
        message_to_screen("Player two",red,-200,200,"small")
        message_to_screen(str(score2),red,-200,300,"small")
        ...
        pygame.draw.circle(screen, red, (int(screen.get_width() / 2), int(screen.get_height() / 2)),int(screen.get_width() / 10), 5)
        #boundaries and center line
        pygame.draw.line(screen , red , divline1, divline2 ,5 )
